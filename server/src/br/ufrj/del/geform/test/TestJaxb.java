...
public class TestJaxb {
	...
	private final static String resource = "jaxb";
	...
	public static void main( String[] args ) {
		...
		System.out.println( service.path( pattern ).path( resource ).accept( MediaType.APPLICATION_XML ).get( String.class ) );
		System.out.println( service.path( pattern ).path( resource ).accept( MediaType.APPLICATION_JSON ).get( String.class ) );
